...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SimpleClient", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SimpleClient", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "SimpleClient";
		app.meta["name"] = "SimpleClient";
